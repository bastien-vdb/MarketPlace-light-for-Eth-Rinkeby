const web3 = Moralis.web3ByChain("0x4"); // Rinkeby Testnet

const nft_market_place_address = "0x414F78e40b31dAC2582c045Aa9C8578469F10743" ;
...
Moralis.Cloud.define("placeOffering", async(request) => {
	const hostContract = request.params.hostContract;
 	...
 	const tokenId = request.params.tokenId;
  	...
  	const nonceOperator = web3.eth.getTransactionCount("0x8d052C590f65e72fe7e7B7B40D7520c2A8DA047A")
